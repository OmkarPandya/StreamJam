     ...
     <img src={logo} height={70} width={70}/>
      ...
      <div class="w-full bg-white rounded-lg shadow border md:mt-0 sm:max-w-md xl:p-0 border-gray-700">
        ...
        />
                  ...
                  <button onClick={handleLogin} disabled={isSubmitButtonDisabled} type="submit" class="w-full text-white bg-pink-600 hover:bg-pink-700 focus:ring-4 focus:outline-none focus:ring-pink-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign in</button>
